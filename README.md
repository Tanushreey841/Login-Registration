📄 Project Documentation: Login & Registration System
1. Project Overview

This project is a Spring Boot web application that allows users to register, log in, and manage their profile. The application implements validation, security, and user-friendly forms.
...
Field validations for date, email, phone, password strength, etc.
2. Technologies Used
...
Password is updated securely using BCrypt
...
gen-radio button
hobbies-multiple
password -str(show) paramiters-  weak-x  strong accept
